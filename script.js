...
function buildInsight() {
  ...
  const insightMap = {
    'ประวัติการทำงาน':          'คุณหยุดอ่านประวัติการทำงานนานที่สุด — คุณต้องการคนที่ผ่านสนามจริงมาแล้ว ไม่ใช่แค่คนที่รู้ทฤษฎี',
    'สิ่งที่จะทำในบริษัทคุณ':   'คุณหยุดอ่านส่วนนี้นานที่สุด — คุณกำลังหาคนที่ตรงกับงานที่ต้องการอยู่ใช่ไหมครับ',
